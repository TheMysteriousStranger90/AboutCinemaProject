    ...
    public static void ContextSeed(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Movie>().HasData(
            new Movie()
            {
                ...
                Year = 1960, Director = "Federico Fellini", RuntimeHours = 2.54,
                PictureUrl = "images/movies/movie1.jpg", MovieGenreId = 4,
                MovieCountryId = 2
            },
            new Movie()
            {
                ...
                Year = 1967, Director = "Jean-Pierre Melville", RuntimeHours = 1.45,
                PictureUrl = "images/movies/movie2.jpg", MovieGenreId = 1,
                MovieCountryId = 1
            },
            new Movie()
            {
                ...
                Year = 1982, Director = "Ridley Scott", RuntimeHours = 1.57, PictureUrl = "images/movies/movie3.jpg",
                MovieGenreId = 2,
                MovieCountryId = 3
            },
            new Movie()
            {
                ...
                Year = 1985, Director = "Elem Klimov", RuntimeHours = 2.22, PictureUrl = "images/movies/movie4.jpg",
                MovieGenreId = 1,
                MovieCountryId = 4
            }
        );
